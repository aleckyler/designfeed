class ResponsesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @response.save
        format.html { redirect_to @response.submission, notice: 'Response was successfully created.' }
  ...
  private
    ...
    def response_params
      params.require(:response).permit(:comment, :html, :css, :user_id, :submission_id)
    end
end
